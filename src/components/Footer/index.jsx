    ...
    <div className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.top}>
          <div className={styles.panto}>
            <h4 className={styles.title}>Panto</h4>
          ...
          <div className={styles.furnitures}>
            <h4 className={styles.subtitle}>Furniture</h4>
            <ul>
              <li>
                <a className={styles.link} href="#Product_active__B6YEP">
                  Beds
                </a>
              </li>
              <li>
              ...
              <a href="/">
                ...
                >
                  ...
                  <path
                    ...
                    fill="#1E2833"
                  />
                  <circle cx="15.3752" cy="4.62499" r="0.66625" fill="#1E2833" />
                </svg>
        ...
        <div className={styles.bottom}>
          <div className={styles.info}>Copyright © 2021</div>
          <div className={styles.infoBox}>
            <div className={styles.infos}>Terms & Conditions</div>
            <div className={styles.infos}>Privacy Policy</div>
          </div>
        </div>
      </div>
    </div>
